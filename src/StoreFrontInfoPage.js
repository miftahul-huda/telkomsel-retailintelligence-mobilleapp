...
export default class StoreFrontInfoPage extends SharedPage
{
    constructor(props)
    {
        super(props);
    ...
    saveStoreFront()
    {
        ...
        if(res.success)
        {
            if(this.state.file.isuploaded)
                this.saveRemoteStoreFront();
            else
                this.saveLocalStoreFront();
        ...
        return(
            ...
            <Header style={{backgroundColor: '#FFF'}}>
                <View  style={Style.headerHorizontalLayout}>
                        ...
                        <Title style={Style.headerTitle}>Perbarui Informasi Tampak Depan</Title>
                </View>
            </Header>
            <Content style={{backgroundColor: '#eee'}} >
                ...
                <View style={{padding: '5%', backgroundColor: '#ffffff'}}>
                    <Button style={Style.buttonRed} onPress={()=>this.saveStoreFront()}>
